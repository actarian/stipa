...
ContactsSimpleComponent.meta = {
  ...
  _proto.onInit = function onInit() {
    ...
    var form = new rxcompForm.FormGroup({
      ...
      firstCategory: new rxcompForm.FormControl(null),
      secondCategory: new rxcompForm.FormControl(null),
...
var YoutubeComponent = /*#__PURE__*/function (_Component) {
  ...
  _proto.player$ = function player$() {
    ...
    return this.id$.pipe(operators.switchMap(function (id) {
      ...
      return YoutubeComponent.once$().pipe(operators.map(function (youtube) {
        ...
        _this.player = new youtube.Player(video, {
          ...
          events: {
            ...
            onPlayerError: _this.onPlayerError
          }
        });
        return _this.player;
      }));
  ...
  _proto.interval$ = function interval$() {
    ...
    return rxjs.interval(500).pipe(operators.filter(function () {
      return _this2.playing && _this2.player;
    }), operators.tap(function () {
      if (_this2.progress) {
        _this2.progress.style.strokeDashoffset = _this2.player.getCurrentTime() / _this2.player.getDuration();
      }
    }));
  };
  ...
  YoutubeComponent.once$ = function once$() {
    ...
    if (this.youtube$) {
      ...
      script.src = '//www.youtube.com/iframe_api'; // console.log('YoutubeComponent.once$', script);
